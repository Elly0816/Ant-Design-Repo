import {CSSProperties, MouseEvent, ReactElement, useState, useContext, useEffect} from 'react';
...
export default function PrimarySearchAppBar(): ReactElement {
  ...
  useEffect(()=>{
    const currencyButton: SxProps<Theme> = location === '/'? buttonPropsActive : buttonProps;
    const favButton: SxProps<Theme> = location === '/favorites'? buttonPropsActive : buttonProps;
